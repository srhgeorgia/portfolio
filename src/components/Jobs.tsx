    ...
    <div ref={aboutRef} className={styles.container}>
      <motion.div animate={controls}>
        ...
        <p className={styles.subTitle}>
          ...
          development. Following the completion of my studies at Senac, I joined
          Indicium as a front-end developer, contributing for 1 year and 8
          months. Driven by a passion for technology and a desire to explore new
          horizons, I transitioned into the realm of data.
        </p>

        <p className={styles.subSubTitle}>
          Currently, I am broadening my skill set by having completed back-end
          development studies at Senac, while continuing my role as a data
          engineer at the same company. This endeavor has enhanced my holistic
          understanding of software development, solidified my technical
          foundation, and prepared me for fresh challenges in the expansive
          field of technology.
        </p>
      </motion.div>
      ...
      <VerticalTimeline>
        <div className={styles.contentJobs}>
          <VerticalTimelineElement
            ...
            date="2024-Present"
            icon={<img src={images.indicium} className={styles.imgIndicium} />}
          >
            <div className={styles.first}>
              <div className={styles.textJobs}>
                <div className={styles.contentText}>
                  <h3 className={styles.expTitle}>Data Engineer</h3>
                  <p className={styles.company}>Indicium</p>
                </div>
              </div>
              <ul className={styles.descriptions}>
                <li className={styles.description}>
                  Development and debugging of taps for data collection and
                  processing.
                </li>
                <li className={styles.description}>
                  Monitoring and analysis of outputs generated by taps with
                  Meltano.
                </li>
                <li className={styles.description}>
                  Data migration to cloud environments, ensuring accessibility
                  and security.
                </li>
                <li className={styles.description}>
                  Work with Docker to facilitate packaging and deployment of
                  applications.
                </li>
                <li className={styles.description}>Use of Node.js and AWS.</li>
                <li className={styles.description}>
                  DAGs creation on Airflow for workflow orchestration, and
                  transfer to Snowflake.
                </li>
                <li className={styles.description}>
                  Local testing of integrations with target-jsonl.
                </li>
                <li className={styles.description}>
                  API testing using Postman to ensure the quality and integrity
                  of services.
                </li>
              </ul>
            </div>
          ...
          <VerticalTimelineElement
            ...
            iconStyle={{ background: "#fff" }}
            date="2022-2022"
            icon={<img src={images.kenzie} className={styles.imgKenzie} />}
          >
            <div className={styles.second}>
              <div className={styles.textJobs}>
                <div className={styles.contentText}>
                  <h3 className={styles.expTitle}>
                    Peer Coaching and Monitoring
                  </h3>
